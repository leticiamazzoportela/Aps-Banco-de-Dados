...
<?php
    ...
    if($executa){
        ...
        echo                "<h4>Consulta 1</h4>";
            
        foreach($executa as $resultado){
            print "idEntregador: ".$resultado['idEntregador'].";"."<br>";
        }
