...
<?php
    ...
    $executa= $pdo->query("SELECT idProduto, NomeProduto
                            FROM Produto
                            WHERE idProduto NOT IN ($pdo->query(SELECT Produto_idProduto
                                                                FROM Pedido_Produto))");
    ...
    if($executa){
        ...
        echo                "<h4>Consulta 3</h4>";
            
        foreach($executa as $resultado){
            print "idProduto: ".$resultado['idProduto'].";"."<br>";
            print "Nome do Produto: ".$resultado['NomeProduto'].";"."<br><br>";
        }
