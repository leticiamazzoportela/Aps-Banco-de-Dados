...
<?php
    ...
    $executa= $pdo->query("SELECT p.idPedido, p.ValorTotal
                            FROM pedido p
                            WHERE p.ValorTotal = ($pdo->query(SELECT max(p2.ValorTotal)
                                                              FROM pedido p2))");
    ...
    if($executa){
        ...
        echo                "<h4>Consulta 8</h4>";
            
        foreach($executa as $resultado){
            print "idPedido: ".$resultado['idPedido'].";"."<br>";
            print "Valor Total: ".$resultado['ValorTotal'].";"."<br><br>";
        }
