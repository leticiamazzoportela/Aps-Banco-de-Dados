...
<?php
    ...
    $executa= $pdo->query("SELECT DISTINCT Veiculo_Placa
                            FROM usa u
                            WHERE u.Veiculo_Placa NOT IN ($pdo->query(SELECT Veiculo_Placa
                                                                      FROM usa s
    ...
    if($executa){
        ...
        foreach($executa as $resultado){
            print "Placa do Veiculo: ".$resultado['Veiculo_Placa'].";"."<br>";
        }
